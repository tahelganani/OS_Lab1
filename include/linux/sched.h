...
/* OS-lab HW1-mpi */
    struct list_head mpi_queue; // Queue of incoming messages
    struct list_head mpi_groups; // list of groups this task is part of
    int mpi_registered; // flag if the task is part of the MPI
};
